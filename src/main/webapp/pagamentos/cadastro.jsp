...
<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3 class="menu_tag">&gt;&gt; PAGAMENTOS - CADASTRAR UM NOVO PAGAMENTO &lt;&lt;</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost/LojaVirtuall/Controller" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control" name="curso" required id="inputCURSO" placeholder="CURSO">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                  <input type="date" class="form-control" name="data" id="inputDATA" title="Preencha o campo Nome" required>
                </div>
              </div>
              <input type="hidden" name="id_formulario" value="3">
              <input type="hidden" name="tipo_formulario" value="33">
