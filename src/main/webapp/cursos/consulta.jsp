...
<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3 class="menu_tag">&gt;&gt; CURSOS - CONSULTAR UM CURSO &lt;&lt;</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" role="form" action="http://localhost/LojaVirtuall/Controller" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="number" name="cdcurso" class="form-control" placeholder="CURSO" required>
                </div>
              </div>
              <input type="hidden" name="id_formulario" value="2">
              <input type="hidden" name="tipo_formulario" value="22">
